...
The 2024 Pathways event series is supported by Openscapes LLC, with funding from a [Mozilla Foundation's Alumni Connection grant](https://foundation.mozilla.org/en/blog/mozilla-announces-first-ever-alumni-connection-grant-finalists/), allowing us to collaborate with [PREreview](https://prereview.org/) and Antoinette Foster, PhD to bring expertise in values-guided career navigation and anti-racist scholarly review to the programming this year. Pathways to Open Science was kicked off with 2023 support from the [Code for Science & Society Event Fund](https://eventfund.codeforscience.org/event-fund-grantees/) through the [Chan Zuckerberg Initiative](https://chanzuckerberg.com/). Thank you!

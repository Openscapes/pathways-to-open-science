...
**What will Pathways to Open Science look like?** Check out the speakers in our [2024 Series](2024.qmd) and speakers and resources shared in our [2023 Series](2023.qmd). 
...
The 2024 Pathways event series is funded in part by Mozilla, NASA Earthdata, and Openscapes LLC. We are grateful to [Mozilla Foundation's Alumni Connection grant](https://foundation.mozilla.org/en/blog/mozilla-announces-first-ever-alumni-connection-grant-finalists/) that supports our collaboration with [PREreview](https://prereview.org/) and Dr. Antoinette Foster’s expertise in values-guided career navigation and anti-racist scholarly review. Pathways to Open Science was kicked off with 2023 support from the [Code for Science & Society Event Fund](https://eventfund.codeforscience.org/event-fund-grantees/) through the [Chan Zuckerberg Initiative](https://chanzuckerberg.com/). Thank you!
